...
<body>
    <div class="container">
        ...
        <form id="signatureForm" action="{{ route('hirer.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <input type="hidden" id="rent_start_date" name="rent_start_date" value="{{ $tokenData->rent_start_date ?? '' }}">
            <input type="hidden" id="rent_end_date" name="rent_end_date" value="{{ $tokenData->rent_end_date ?? '' }}">
            ...
            <input type="hidden" id="deposit_amount" name="deposit_amount" value="{{ $tokenData->deposit_amount ?? '' }}">
