{{-- this agreement was sharing to mail from the vehicles list table --}}
                    ...
                    <tr>
                        ...
                        <td class="empty-cell">
                            <input type="date" name="authorised_driver_dob" class="form-control"
                                value="{{ old('authorised_driver_dob') }}">
...
@elseif ($vehicle->company_name == 'EMM Kay Group')
            <h5 style="margin-top: 20px;">EMM KAY GROUP PTY LTD - ABN: 52 652 574 528 - Hire Terms and Conditions
                ...
                Trade</h5>
        @else
            <h5 style="margin-top: 20px;">Vaa Transport Pty Ltd - Hire Terms and Conditions
                of
                Trade</h5>
        @endif
    ...
    <script>
        ...
        function calculateTotal() {
            ...
            const perDayPrice = parseFloat(document.getElementById('per_day_price').value) || 0;

            if (startDate && endDate && endDate >= startDate) {
                const totalDays = Math.ceil((endDate - startDate) / (1000 * 60 * 60 * 24)) +
                    1; // +1 to include the start day
                const totalPrice = totalDays * perDayPrice;
