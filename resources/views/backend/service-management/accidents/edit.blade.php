    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row g-6">
            ...
            <div class="card">
                <div class="row">
                    <div class="col-sm-4">
                        <h5 class="card-header">Edit Accident Details</h5>
                    </div>
                    ...
                    <div class=" mb-6">
                        ...
                        <form action="{{ route('services.accident.update', $accident->id) }}" method="post"
                            ...
                            <div>
                                ...
                                <div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="col-form-label">Accident Date <span
                                                        class="text-danger">*</span></label>
                                                <input type="date" name="accident_date" id="accident_date"
                                                    class="form-control" value="{{ $accident->accident_date }}">
                                                @error('accident_date')
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="custom-dropdown mt-2">
                                                    <input type="text" class="form-control" id="search_reg_no"
                                                        ...
                                                        value="{{ $accident->vehicle->reg_no }}">
                                                    <input type="hidden" id="vehicle_id" name="vehicle_id"
                                                        value="{{ $accident->vehicle_id }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="col-form-label">Insurance Reference <span
                                                        class="text-danger">*</span></label>
                                                <input type="text" name="insurance_ref" id="insurance_ref"
                                                    class="form-control" value="{{ $accident->insurance_ref }}">
                                                @error('insurance_ref')
                                                    <p class="text-red-400 font-medium">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                id="description_update" class="form-control">{{ $accident->description }}</textarea>
                                                @error('description')
                                                    <p class="text-red-400 font-medium">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="file" name="file[]" class="form-control"
                                                    id="fileInputUpdate" multiple>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <!-- File Preview Container with Bootstrap Grid -->
                                                <div id="filePreviewUpdate" class="row mt-3">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                                ...
                                                                <div class="file-preview-item">
                                                                    <div class="d-flex align-items-center text-center">
                                                                        <div class="flex-grow-1">
                                                                            @if (Str::endsWith($file->file, ['.jpg', '.jpeg', '.png', '.webp']))
                                                                                <img src="{{ asset($file->file) }}"
                                                                                    alt="{{ basename($file->file) }}"
                                                                                    class="img-thumbnail"
                                                                                    style="max-width: 100%; max-height: 85px;">
                                                                                <span>{{ basename($file->file) }}</span>
                                                                            @elseif (Str::endsWith($file->file, '.pdf'))
                                                                                <embed src="{{ asset($file->file) }}"
                                                                            ...
                                                                            @elseif (Str::endsWith($file->file, ['.doc', '.docx']))
                                                                                <iframe
                                                                                    src="https://view.officeapps.live.com/op/embed.aspx?src={{ urlencode(asset($file->file)) }}"
                                                                                    width="100%" height="100%"
                                                                                    style="max-height: 85px;"></iframe>
                                                                                <span>{{ basename($file->file) }}</span>
                                                                            @endif
                                                                        </div>
                                                ...
                                                <!-- New Files Preview -->
                                                <div id="filePreviewUpdate" class="row mt-3"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
@section('scripts')
    ...
    <script>
        ...
        initializeCKEditor('description_update');
                            ...
                            <div class="col-md-4 mb-3 position-relative">
                                <div class="file-preview-item border p-2">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-grow-1">
                                            <img src="${fileURL}" alt="${file.name}" class="img-thumbnail" style="max-width: 100%; max-height: 85px;">
                                        </div>
                            ...
                            previewElement = `
                                <div class="col-md-4 mb-3 position-relative">
                                    <div class="file-preview-item border p-2">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <iframe src="${fileURL}#page=1" width="100%" height="100%" style="max-height: 85px;"></iframe>
                                            </div>
                                            <div class="ms-2 position-absolute" style="top: 9px; right: 21px;">
                                                <button type="button" class="btn btn-danger btn-sm remove-file" data-file-index="${i}">
                                                        <i class="icon-base ti tabler-trash me-1"></i>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.delete-file', function() {
                ...
                $fileElement.html(
                    '<div class="text-center"><i class="icon-base ti tabler-loader me-1"></i> Deleting...</div>');
