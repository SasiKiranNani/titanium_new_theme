                ...
                <div class="row">
                    ...
                    <div class="col-sm-8 card-header">
                        <div class="d-flex align-items-center flex-wrap row-gap-2 justify-content-sm-end">
                            <a href="{{ route('services.company-vehicle') }}" class="btn create-new btn-primary">
                                <span>
                    ...
                    <div class=" mb-6">
                        ...
                        <form action="{{ route('services.company-vehicle.update', $serviceBooking->id) }}" method="POST"
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="col-form-label">Registration Number <span
                                                        class="text-danger">*</span></label>
                                                <div class="custom-dropdown mt-2" style="position: relative;">
                                                    <input type="text" class="form-control"
                                                        id="search_reg_no_{{ $serviceBooking->id }}"
                                                        placeholder="Select a registration number"
                                                        value="{{ $serviceBooking->vehicle->reg_no ?? '' }}" readonly>
                                                    <input type="hidden" id="vehicle_id_{{ $serviceBooking->id }}"
                                                        name="vehicle_id" value="{{ $serviceBooking->vehicle_id ?? '' }}">
                                                </div>
                                                @error('reg_no')
                                                    <p class="text-red-400 font-medium">{{ $message }}</p>
                                                @enderror
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="make" id="make" class="form-control"
                                                    readonly value="{{ old('make', $serviceBooking->make) }}">
                                                @error('make')
                                                    <p class="text-red-400 font-medium">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="model" id="model" class="form-control"
                                                    readonly value="{{ old('model', $serviceBooking->model) }}">
                                                @error('model')
                                                    <p class="text-red-400 font-medium">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="vin" id="vin" class="form-control"
                                                    readonly value="{{ old('vin', $serviceBooking->vin) }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="color" id="color" class="form-control"
                                                    readonly value="{{ old('color', $serviceBooking->color) }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
