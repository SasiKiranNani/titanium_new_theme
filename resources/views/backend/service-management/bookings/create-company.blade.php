                            ...
                            <div>
                                ...
                                <div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="odometer" class="col-form-label">Odometer Reading</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="col-form-label">Job Price </label>
...
@section('scripts')
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const engineNoInput = document.getElementById('engine_no');
            ...
            optionsContainer.addEventListener('click', function(event) {
                if (event.target.classList.contains('option')) {
                    ...
                    // Populate fields
                    makeInput.value = selectedOption.getAttribute('data-make') || '';
                    purchaseDateInput.value = selectedOption.getAttribute('data-purchase_date') || '';
                    vinInput.value = selectedOption.getAttribute('data-vin') || '';
                    engineNoInput.value = selectedOption.getAttribute('data-engine_no') || '';
