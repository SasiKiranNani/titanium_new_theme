        ...
        var d = {
            ...
            _scrollToActive: function () {
                ...
                if (n) {
                    ...
                    if (o) {
                        ...
                        if (!0 === e) {
                            ! function e() {
                                var n, o, u, l = +new Date - s,
                                    c = (n = l, o = r, u = a, (n /= t / 2) < 1 ? u / 2 * n * n + o : -u / 2 * ((n -= 1) * (n - 2) - 1) + o);
                                i.scrollTop = c, l < t ? requestAnimationFrame(e) : i.scrollTop = a
                            }()
                        } else i.scrollTop = a
                    }
                }
            ...
            on: function () {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : c("event"),
                    ...
                    i = o(e.split("."), 1)[0],
                    r = n(e.split(".")).slice(1);
                r = r.join(".") || null, this._listeners.push({
                    event: i,
                    namespace: r,
                    callback: t
                })
